 ...
 * });
 * 
 * NOTE: commented out all the alert boxes and throw errors. also updated
 * optimiseZoomLevel() around line 200 so as to not resize if addresses=1 but
 * resize if addresses > 1.
 **/
